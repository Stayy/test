...
class ScanFeatureMatcherNode(Node):
    ...
    def _declare_parameters(self) -> None:
        ...
        self.declare_parameter("line_isolation_enabled", True)
    ...
    def _pattern_config(self) -> PolePatternConfig:
        return PolePatternConfig(
            ...
            line_isolation_enabled=bool(
                self.get_parameter("line_isolation_enabled").value
            ),
            line_isolation_lateral_tolerance=float(
                self.get_parameter("line_isolation_lateral_tolerance").value
            ),
            line_isolation_extension=float(
                self.get_parameter("line_isolation_extension").value
            ),
